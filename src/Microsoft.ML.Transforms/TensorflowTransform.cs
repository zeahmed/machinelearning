...
namespace Microsoft.ML.Transforms
{
    public sealed class TensorflowTransform : RowToRowMapperTransformBase
    {
        ...
        /// <summary>
        /// Helper method to create <see cref="TensorflowTransform"/>.
        /// </summary>
        /// <param name="env">Host Environment.</param>
        /// <param name="input">Input <see cref="IDataView"/>. This is the output from previous transform or loader.</param>
        /// <param name="modelFile">This is the frozen tensorflow model file. https://www.tensorflow.org/mobile/prepare_models </param>
        ...
        public static TensorflowTransform Create(IHostEnvironment env, IDataView input, string modelFile, string[] outputColumns, string[] inputColumns)
        {
            ...
            for (int i = 0; i < args.Column.Length; i++)
            {
                ...
                foreach (var inputCol in outputColumns)
                {
                    args.Column[i].Name = inputCol;
                    args.Column[i].Source = inputColumns;
                }
            }

            return new TensorflowTransform(env, args, input);
        }
